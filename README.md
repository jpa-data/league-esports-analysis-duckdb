...
2. Basic Player Performance in at international events
3. Champion and Game Meta analysis

# KEY INSIGHTS

- G2 Esports has the highest win rate against Korean Teams this year at 58.82%, at the same time they have the worst overall win rate of Team with many games played.
- North American Teams have a staggering 80% win rate against European Teams since the beginning of 2025.
- Korea (LCK) is the only region to have a positive win rate against every other region.
- The number of unique Champions played does not correlate with the amount of games played.
- Bot lane has already had more unique champions played in this ongoing season that during the entirety of last year.
...
1. Download the raw .csv files for the 2025 and 2026 season at: and place them in the data/raw/ directory. These files are roughly 150mb combined.
